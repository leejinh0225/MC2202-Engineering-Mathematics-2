...
('2','표기 대조: 세로 벡터의 +4와 아래 계산식의 −4','아래 계산식은 4−2−6+4=0으로 올바르며, 그 계산에 사용된 벡터는 직교합니다. 본문은 계산식 기준으로 설명하고 세로 벡터의 표기 차이는 분리합니다.'),
...
('24','노트 정정: c₀가 생략되었다는 기존 설명 철회','원본 그래프에 |c₀|=1/2가 이미 표시되어 있습니다. 본문은 c₀=1/2의 적분 과정을 보강합니다. 원본 그래프 가로축은 n이며, 각주파수 좌표는 2πn입니다.'),
...
('28, 30, 32, 47','문제 조건 재대조 · 풀이 출처 명확화','반파 정류파의 2L=2π/ω, 톱니파의 x+π와 (−π,π), 삼각 펄스의 2k/L와 L/2, 고유값 문제의 y(0)=y(π)=0을 재확인했습니다. 원본은 문제만 제시하며 완성 풀이는 편집자 작성입니다.'),
...
template=template.replace('</head>','<link rel="stylesheet" href="assets/vendor/katex/katex.min.css"><link rel="stylesheet" href="assets/css/math-note.css?v=transforms-1"><script src="assets/js/mode-init.js"></script></head>')
